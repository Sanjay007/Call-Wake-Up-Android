...
//
        ...
        if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.O) {
            Log.d(TAG,"Greater Oreo");
            return buildNotification( " is calling.",
    ...
    private Notification buildNotification(String text, Bundle extras,
        ...
        Notification.Builder builder =
                new Notification.Builder(getApplicationContext(), channelId)
                        ...
                        .addAction(android.R.drawable.ic_menu_call,"Anser", piAcceptIntent);
    ...
    private void accept(CallInvite callInvite, int notificationId) {
        endForeground();
//        Intent activeCallIntent = new Intent(this, VideoActivity.class);
